...
def test_simple_token():
    ...
    examples = "+-*/%()" # Added modulo to examples
...
# Added function to test modulo
def test_modulo():
    print("test modulo")
    tokens = tokenize("8%4")
    assert tokens == [{'tag': 'number', 'position': 0, 'value': 8}, {'tag': '%', 'position': 1, 'value': '%'}, {'tag': 'number', 'position': 2, 'value': 4}, {'tag': None, 'value': None, 'position': 3}]
